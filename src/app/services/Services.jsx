...
const Services = () => {
  return (
    <div className="pt-10 bg-gradient-to-r from-orange-50 to-orange-100">
    

      <section className="min-h-screen p-6 ">
        <h1 className="text-4xl md:text-5xl font-bold text-[#7B2F14] mb-8 text-center">
          Our Services
        </h1>
             ...
             {KCS_Promises.map((step, index) => (
               ...
               >
                 <Image
                   src={step.img}
                   alt={step.title}
                   className="w-16 h-16 mb-4 min-blend-multiply"
                   width={64}
                   height={64}
                   loading="lazy"
                 />
